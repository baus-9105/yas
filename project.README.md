...
![YAS](https://raw.githubusercontent.com/nashtech-garage/yas/main/yas-architecture-local.png)
...
6. Bỏ qua phần này nếu làm phần Nâng Cao: Tương tự, trên Jenkins tạo ra 2 job CI/CD để deploy "dev" và "staging".
    ...
    2.  Staging: trên "main" branch sẽ có đáng tag để có dạng release, ví dụ: tag v1.2.3. thì job CI/CD sẽ phát hiện và build image với tag cuối cùng, ví dụ tag v1.2.3 (hoặc tách branch rc_v1.2.3, hoặc vừa tag và tách branch), sau đó push images này lên Docker Hub và deploy vào trong namespace "staging"

Nâng cao (2đ): Sử dụng AgroCD để handle được "dev" và "staging"

![YAS-ArgoCD](docs/images/yas-argocd.png)
